...
// CRITICAL FIX: Serve static files from current directory instead of 'public'
app.use(express.static(__dirname));

// CRITICAL FIX: Add explicit route for root path
app.get('/', (req, res) => {
...
server.listen(PORT, () => {
    ...
    console.log(`🌐 Root route configured for index.html`);
});